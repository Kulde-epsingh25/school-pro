...
export default function NewSchoolFeePage() {
  ...
  useEffect(() => {
    // Fetch terms
    fetch("https://school-pro-api-6mxq-5qzq.onrender.com/academics/terms")
      .then(res => res.json())
      .then(data => {
        setTerms(data);
    ...
    // fetch("https://school-pro-api-6mxq-5qzq.onrender.com/academics/classes")
  }, []);
  ...
  const handleSave = async () => {
    ...
    try {
      await fetch("https://school-pro-api-6mxq-5qzq.onrender.com/finance/fees", {
        method: "POST",
