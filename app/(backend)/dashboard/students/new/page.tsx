...
export default function NewStudentPage() {
  ...
  const fetchData = async () => {
    try {
      const [parentsRes, classesRes] = await Promise.all([
        fetch("https://school-pro-api-6mxq.onrender.com/parents").catch(() => null),
        fetch("https://school-pro-api-6mxq.onrender.com/classes").catch(() => null)
      ]);
  ...
  const handleParentSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("https://school-pro-api-6mxq.onrender.com/parents", {
        method: "POST",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("https://school-pro-api-6mxq.onrender.com/students", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
