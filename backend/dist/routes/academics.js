...
router.get("/departments/:id", academics_1.getDepartment);
router.put("/departments/:id", academics_1.updateDepartment);
router.delete("/departments/:id", academics_1.deleteDepartment);
