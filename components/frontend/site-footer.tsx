        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-white/90">
              Trusted by 100+ schools, School Pro is the all-in-one school management software that simplifies administration, enhances communication, and empowers educators to focus on what matters most – student success.
            </p>
            <div className="flex space-x-4">
              ...
              >
                <FaTwitter className="h-4 w-4 text-[#6366F1]" />
              ...
              <Link
                ...
                className="rounded-full bg-white p-2 hover:bg-white/90"
              >
                <FaInstagram className="h-4 w-4 text-[#6366F1]" />
              ...
              <Link
                ...
                className="rounded-full bg-white p-2 hover:bg-white/90"
              >
                <FaLinkedinIn className="h-4 w-4 text-[#6366F1]" />
              ...
              <Link
                ...
                className="rounded-full bg-white p-2 hover:bg-white/90"
              >
                <FaYoutube className="h-4 w-4 text-[#6366F1]" />
      ...
      <div className="border-t border-white/10">
        <div className="container flex flex-col items-center justify-center gap-4 py-6 text-center text-sm md:h-16 md:flex-row md:py-0">
          <div className="text-white/60">
            Copyright@2026 All Right Reserved School Pro.
          </div>
        </div>
      </div>
    </footer>
