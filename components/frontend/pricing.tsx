      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            ...
            finances — all in one platform. No hidden fees, no surprises.
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="mt-6 text-base leading-7 text-gray-600">
              Get full access to all modules including Student Management,
              Academic Planning, Staff Payroll, Transport Tracking, and more —
            ...
            <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="mx-auto max-w-xs px-8">
                <p className="text-base font-semibold text-gray-600">
                  {isAnnual ? "Pay yearly, save 15%" : "Flexible monthly plan"}
                </p>
